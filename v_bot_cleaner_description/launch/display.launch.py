...
def generate_launch_description():
    pkg_share = launch_ros.substitutions.FindPackageShare(package='v_bot_cleaner_description').find('v_bot_cleaner_description')
    ...
    spawn_entity = launch_ros.actions.Node(
        ...
        arguments=['-entity', 'v_bot_cleaner', '-topic', 'robot_description'],
        parameters=[{'use_sim_time': use_sim_time}],
        output='screen'
    )
